...
${TESTDIR}/tests/TestTextSearch.o: tests/TestTextSearch.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/TestTextSearch.o tests/TestTextSearch.cpp
...
${OBJECTDIR}/TextSearch_nomain.o: ${OBJECTDIR}/TextSearch.o TextSearch.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TextSearch_nomain.o TextSearch.cpp;\
	else  \
