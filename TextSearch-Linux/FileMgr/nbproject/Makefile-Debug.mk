...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libFileMgr.${CND_DLIB_EXT}: ${OBJECTFILES}
	...
	gcc -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libFileMgr.${CND_DLIB_EXT} ${OBJECTFILES} ${LDLIBSOPTIONS} -shared -fPIC
...
${TESTDIR}/TestFiles/f1: ${TESTDIR}/tests/TestFileMgr.o ${OBJECTFILES:%.o=%_nomain.o}
	...
	${LINK.cc}   -o ${TESTDIR}/TestFiles/f1 $^ ${LDLIBSOPTIONS} -ldl 


${TESTDIR}/tests/TestFileMgr.o: tests/TestFileMgr.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -std=c++11 -pthread -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/TestFileMgr.o tests/TestFileMgr.cpp
...
${OBJECTDIR}/FileMgr_nomain.o: ${OBJECTDIR}/FileMgr.o FileMgr.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FileMgr_nomain.o FileMgr.cpp;\
	else  \
